...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <section class="page-section" id="daftar">
            ...
            <div class="container">
                <div class="text-center">
                    <h2 class="section-heading text-uppercase">Form Pendaftaran PKL/Magang</h2>
                </div>
                @if (session('status'))
                ...
                @endif
                <form id="daftar" action="{{url('daftar')}}" method="POST" name="daftar" >
                    @csrf
                    <div class="row align-items-stretch mb-5">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="nama" class="form-label">Nama</label>
                                <input class="form-control" name="nama" id="nama" type="text" placeholder="Name *" required="required" data-validation-required-message="Please enter your name." />
                                <p class="help-block text-danger"></p>
                            </div>
                            <div class="form-group">
                                <label for="nim" class="form-label">Nim</label>
                                <input class="form-control" name="nim" id="nim" type="text" placeholder="Nim *" required="required" data-validation-required-message="Please enter your nim." />
                                <p class="help-block text-danger"></p>
                            </div>
                            <div class="form-group">
                                <label for="jurusan" class="form-label">Jurusan</label>
                                <input class="form-control" name="jurusan" id="jurusan" type="text" placeholder="Jurusan *" required="required" data-validation-required-message="Please enter your jurusan." />
                                <p class="help-block text-danger"></p>
                            </div>
                            <div class="form-group">
                                <label for="kampus" class="form-label">Kampus</label>
                                <input class="form-control" name="kampus" id="kampus" type="text" placeholder="Kampus *" required="required" data-validation-required-message="Please enter your kampus." />
                                <p class="help-block text-danger"></p>
                            </div>
                            <div class="form-group">
                                <label for="tgl_masuk" class="form-label">Tanggal Masuk</label>
                                <input class="form-control" name="tgl_masuk" id="tgl_masuk" type="date" required="required" data-validation-required-message="Please enter your tanggal." />
                                <p class="help-block text-danger"></p>
                            </div>
                            <div class="form-group">
                                <label for="tgl_keluar" class="form-label">Tanggal Keluar</label>
                                <input class="form-control" name="tgl_keluar" id="tgl_keluar" type="date" required="required" data-validation-required-message="Please enter your tanggal." />
                                <p class="help-block text-danger"></p>
                            </div>
                    ...
                    <div class="text-center">
                        <div id="success"></div>
                        <button class="btn btn-primary btn-xl text-uppercase" type="submit">Daftar</button>
                    </div>
                </form>
            </div>
        </section>
